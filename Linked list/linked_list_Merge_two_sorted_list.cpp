...
int main() 
{
    node *h1=NULL;
    node *h2=NULL;
    cout<<"enter the list for linked list 1 terminating with -1 in sorted order"<<endl;
    h1=take_input();
    cout<<"Enter the list for linked list 2 terminating with -1 in sorted order"<<endl;
    h2=take_input();
    cout<<"Linked List 1:-"<<endl;
    cout<<h1<<endl;
    cout<<"Linked List 2:-"<<endl;
    cout<<h2<<endl;
    cout<<"After sorting the two sorted linked list"<<endl;
    node *sorted_list=merge(h1,h2);
