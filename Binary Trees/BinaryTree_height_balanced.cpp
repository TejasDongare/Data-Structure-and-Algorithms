...
int main() 
{
    ...
    height_balanced_pair temp=is_height_balanced(head);
    if(temp.ans)
    {
        cout<<"Tree is balanced and height of the tree is:-"<<temp.height<<endl;
    }
    else
    {
        cout<<"Tree is not balanced and height of the tree is:-"<<temp.height<<endl;
    }
}
